...
public class AccessDB {
    ...
    public static void addRelation (long user,long friend) throws ClassNotFoundException, SQLException {
        // 1. load driver
        Class.forName("org.postgresql.Driver");
        ...
        // 4. create a query statement
        PreparedStatement pSt = conn.prepareStatement("INSERT INTO relations (id_usr,id_friend) VALUES ('"+user+"','"+friend+"')");
    ...
    public static List readTweets(String name) throws ClassNotFoundException, SQLException {
        // 1. load driver
        Class.forName("org.postgresql.Driver");
        ...
        // 5. execute a query
        ResultSet rs = st.executeQuery("SELECT * FROM tweet WHERE content LIKE '&"+name+"&' order by insertdate desc ");
